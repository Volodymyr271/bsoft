...
<?php
  switch ($cs) {
  case 0: 
    echo "Лицензирование рабочих мест в сетевой программе";
    break;
  case 1:
    echo $proj." - лицензирование рабочих мест";
    break;
  }
?>
</h1>
...
<table class=module cellpadding=15>
  ...
  <tr><td>
   ...
   Для получения лицензии на дополнительные рабочие места в сетевой программе
   необходимо отправить нам заявку одним из указанных ниже способов:
  <UL>
  <LI>автоматически из программы через пункт меню <b>Справка -> Регистрация</b> с выбором <b>Регистрация клиентов</b>.
  ...
  <LI>вручную, отправив письмо с заявкой и регистрационной анкетой на адрес <b><a href=mailto:support@bsoft.net.ua>support@bsoft.net.ua</a></b>.
      <br>
      Шаблон заявки в формате Microsoft Word возьмите здесь:   <b><A class=redlink href="./dl/licdecl.rtf">Заявка.rtf</A></b>
      <br>
  ...
  мы в течении часа вышлем Вам код лицензии на Ваш e-mail, который<br>
  <font color="#FF0000"><b> подключит к программе новые рабочие места !!!</b></font>
  <br>
   <P align=right><a class=a1 href=javascript:history.back()>Назад</a></P>
</td></tr>
