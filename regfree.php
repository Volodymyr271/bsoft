...
<?php
  switch ($cs) {
  case 0: 
    echo "Бесплатная регистрация однопользовательских программ";
    break;
  case 1:
    echo $proj." - бесплатная регистрация";
    break;
  }
?>
</h1>
...
<table class=module cellpadding=15>
  ...
  <tr><td>
   ...
   Для бесплатной регистрации необходимо отправить нам заявку на получение бесплатного регистрационного кода одним из указанных ниже способов:
  <UL>
  <LI>автоматически из программы через пункт меню <b>Справка -> Регистрация</b> с выбором бесплатной регистрации. 
  ...
  <LI>вручную, отправив письмо с заявкой и регистрационной анкетой на адрес <b><a href=mailto:support@bsoft.net.ua>support@bsoft.net.ua</a></b>.
      <br>
      Шаблон заявки в формате Microsoft Word возьмите здесь:   <b><A class=redlink href="./dl/freedecl.rtf">Заявка.rtf</A></b>
      <br>
  ...
  <br>
  После получения заявки мы вышлем на ваш e-mail бесплатный регистрационный код, который отменит ограничения незарегистрированой версии программы.
  <br>
   <P align=right><a class=a1 href=javascript:history.back()>Назад</a></P>
  </td></tr>
